...
<body translate="no">
    <main>
        ...
        <div class="row px-4">
            <div class="blue-button mr-auto mt-4 medium">Check available</div>
        </div>
    </main>
    ...
    <script id="rendered-js">
        ...
        on('change', function() {
            var start = $(dateDepart.datepicker('getDate'), spanDateFormat);
            var end = $(dateReturn.datepicker('getDate'), spanDateFormat);
